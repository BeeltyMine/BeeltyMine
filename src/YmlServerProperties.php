...
final class YmlServerProperties{
	...
	public const HOPPER_ITEMSPERUPDATE = 'hopper.itemsPerUpdate';
	public const HOPPER_TRANSFERCOOLDOWN = 'hopper.transferCooldown';
	public const HOPPER_UPDATESPERTICK = 'hopper.updatesPerTick';
	public const ITEM = 'item';
	public const ITEM_DESPAWNSECONDS = 'item.despawnSeconds';
	public const ITEM_MAXPERWORLD = 'item.maxPerWorld';
	...
	public const SETTINGS_CONTINUE_ON_PLUGIN_LOAD_ERROR = 'settings.continue-on-plugin-load-error';
