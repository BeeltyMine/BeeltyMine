...
use pocketmine\world\sound\DoorCloseSound;
use pocketmine\world\sound\DoorOpenSound;
...
class Door extends Transparent implements HorizontalFacing{
	...
	public function onInteract(Item $item, int $face, Vector3 $clickVector, ?Player $player = null, array &$returnedItems = []) : bool{
		...
		$world->addSound($this->position, $this->open ? new DoorOpenSound() : new DoorCloseSound());
