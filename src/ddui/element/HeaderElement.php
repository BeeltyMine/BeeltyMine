...
final class HeaderElement extends Element{
	public function __construct(string|Observable $text, ?HeaderOptions $options, ObjectProperty $parent){
	...
	public function setVisibility(bool|Observable $visible) : static{
		...
		if($visible instanceof Observable){
			$property = $this->resolveBooleanProperty("header_visible", true);
