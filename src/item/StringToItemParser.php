...
final class StringToItemParser extends StringToTParser{
	...
	private static function registerBlocks(self $result) : void{
		...
		$result->registerBlock("dispenser_block", fn() => Blocks::DISPENSER());
		...
		$result->registerBlock("dropper_block", fn() => Blocks::DROPPER());
		...
		$result->registerBlock("observer_block", fn() => Blocks::OBSERVER());
		...
		$result->registerBlock("pale_hanging_moss", fn() => Blocks::PALE_HANGING_MOSS());
		$result->registerBlock("pale_moss_block", fn() => Blocks::PALE_MOSS_BLOCK());
		$result->registerBlock("pale_moss_carpet", fn() => Blocks::PALE_MOSS_CARPET());
		...
		$result->registerBlock("piston_block", fn() => Blocks::PISTON());
		...
		$result->registerBlock("shelf", fn() => Blocks::OAK_SHELF());
		...
		$result->registerBlock("sticky_piston_block", fn() => Blocks::STICKY_PISTON());
